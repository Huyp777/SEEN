...
config.TAN.ATTEN_MODULE = edict()
config.TAN.ATTEN_MODULE.NAME = ''
config.TAN.ATTEN_MODULE.PARAMS = None
config.TAN.CROSS_MODULE = edict()
config.TAN.CROSS_MODULE.NAME = ''
config.TAN.CROSS_MODULE.PARAMS = None
